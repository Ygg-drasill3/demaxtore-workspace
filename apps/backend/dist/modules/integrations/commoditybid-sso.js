...
export const commoditybidSso = [
    ...
    asyncHandler(async (req, res) => {
        ...
        const rawNext = sanitizeRedirect(req.query.next) ??
        ...
        try {
            ...
            if (bridgeRes.ok) {
                ...
                logger.warn({ status: bridgeRes.status, apiBase: API_BASE }, "CommodityBid workspace-sso returned non-OK status");
            }
        }
        catch (err) {
...
//# sourceMappingURL=commoditybid-sso.js.map