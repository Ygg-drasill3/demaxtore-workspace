...
export class ManualTrackingProvider {
    name = "MANUAL";
    ...
    async fetchTracking(ctx) {
        ...
        const statuses = ["BOOKED", "DEPARTED", "IN_TRANSIT", "IN_TRANSIT", "ARRIVED_PORT", "COMPLETED"];
        ...
        const delayFlag = gen >= 2 && (status === "IN_TRANSIT" || status === "DEPARTED") ? "MINOR" : "NONE";
        return {
            provider: "MANUAL",
