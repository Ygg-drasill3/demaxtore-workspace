...
systemRouter.get("/export/:reportType.csv", asyncHandler(async (req, res) => {
    ...
    res.setHeader("Content-Disposition", `attachment; filename="system-${req.params.reportType}.csv"`);
    res.send(csv);
}));
