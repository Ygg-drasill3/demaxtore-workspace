...
router.get("/shipments", requireAuth, requireForwarderPortalAccess(), asyncHandler(async (req, res) => {
...
router.post("/shipments/:id/milestones", requireAuth, requireForwarderPortalAccess(), asyncHandler(async (req, res) => {
...
//# sourceMappingURL=forwarder.routes.js.map