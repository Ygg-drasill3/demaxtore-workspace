...
export async function scanMixedContainerAlerts(db) {
    let n = 0;
    const now = new Date();
    ...
    for (const ws of executionActive) {
        ...
        const eligibleNoFreight = orders.filter((o) => ["PRODUCTION_COMPLETED", "INSPECTION_COMPLETED", "FREIGHT_REQUESTED"].includes(o.state)).length;
...
//# sourceMappingURL=mixed-container-alerts.js.map