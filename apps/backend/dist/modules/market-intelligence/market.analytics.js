...
export function classifyForwarder(params) {
    ...
    if (params.revenue >= 2000 && win >= 0.2 && params.routes >= 3)
        return "Strategic Partner";
    if (params.selections >= 2 || params.revenue >= 500)
        return "Core Partner";
    if (params.offers >= 2)
        return "Emerging";
    return "Underutilized";
}
export function categoryTrend(growthPct) {
    if (growthPct >= 15)
        return "growing";
    if (growthPct <= -10)
        return "declining";
...
//# sourceMappingURL=market.analytics.js.map