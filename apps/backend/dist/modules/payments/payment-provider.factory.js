...
export function isOnlinePaymentCollectionEnabled() {
...
export function isPaymentIntentApiEnabled() {
...
export function resolvePaymentProvider() {
    ...
    if (isProd) {
        throw new AppError(503, "ONLINE_PAYMENTS_DISABLED", {
            message: "Online payment collection is not enabled. Payment milestones can be recorded manually.",
        });
    }
