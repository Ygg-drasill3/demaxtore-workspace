...
export class FreightAnalyticsService {
    ...
    async getInsight() {
        ...
        const revenueByRoute = [...routeAgg.entries()].map(([route, v]) => ({
            route,
            lane: v.lane,
    ...
    async buildForwarderScorecards() {
    ...
    async persistSnapshots(period, routes, forwarders) {
        const batch = [
...
//# sourceMappingURL=freight-analytics.service.js.map