...
import { CreateDirectPurchaseOrderPublicSchema, CreateMinimalSupplierSchema, } from "@dmx/contracts/purchase-order.zod";
import { SocketEvents } from "@dmx/contracts/socket-events";
import { AppError } from "../../utils/httpErrors.js";
import { socketBus } from "../../realtime/socket-bus.js";
import { assertCanCreateDirectPo, assertCanCreateMinimalSupplier, } from "./purchase-order.policy.js";
import { assertDirectPoDocumentOwnership, markDirectPoDocumentConsumed, parseDirectPoDocumentUploadId, } from "./direct-purchase-order.document.js";
...
export class DirectPurchaseOrderService {
    ...
    async searchSuppliers(actor, query) {
        assertCanCreateDirectPo(actor);
    ...
    async createMinimalSupplier(actor, raw) {
    ...
    async assertSupplierAccessible(supplierId) {
        ...
        if (supplier.role !== "SUPPLIER")
            throw new AppError(403, "SUPPLIER_ACCESS_DENIED");
    }
}
export { parseDirectPoDocumentUploadId };
//# sourceMappingURL=direct-purchase-order.service.js.map