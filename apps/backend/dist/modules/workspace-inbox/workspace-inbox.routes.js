...
workspaceInboxRouter.get("/", asyncHandler(async (req, res) => {
    ...
    res.json(await adapters().workspaceInbox.getInbox(() => service().getInbox(actor, query), toMessagingActor(actor)));
}));
//# sourceMappingURL=workspace-inbox.routes.js.map