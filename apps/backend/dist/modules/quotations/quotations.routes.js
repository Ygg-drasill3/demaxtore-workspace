...
import { SubmitQuotationPayload, AdminSubmitQuotationPayload, ReviseQuotationPayload, WithdrawQuotationPayload, } from "@dmx/contracts/rfq.zod";
...
router.get("/admin/scope/:supplierUserId", requireAuth, requireRole("ADMIN", "SUPER_ADMIN"), asyncHandler(async (req, res) => {
...
router.post("/admin", requireAuth, requireRole("ADMIN", "SUPER_ADMIN"), validateBody(AdminSubmitQuotationPayload), asyncHandler(async (req, res) => {
...
router.patch("/admin/:quotationId", requireAuth, requireRole("ADMIN", "SUPER_ADMIN"), validateBody(AdminSubmitQuotationPayload), asyncHandler(async (req, res) => {
...
router.post("/", requireAuth, validateBody(SubmitQuotationPayload), asyncHandler(async (req, res) => {
...
router.patch("/:quotationId", requireAuth, validateBody(ReviseQuotationPayload), asyncHandler(async (req, res) => {
...
router.delete("/:quotationId", requireAuth, validateBody(WithdrawQuotationPayload), asyncHandler(async (req, res) => {
