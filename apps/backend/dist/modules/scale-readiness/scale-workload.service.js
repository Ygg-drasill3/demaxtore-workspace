...
export class ScaleWorkloadService {
    ...
    async getOperatorWorkload() {
        ...
        const orgsByOps = new Map();
        for (const o of ownerships) {
            if (!o.operationsUserId)
                continue;
        ...
        for (const admin of admins) {
            ...
            const activeShipments = orderIds.length
                ...
                : 0;
            const openAlerts = orderIds.length > 0
...
//# sourceMappingURL=scale-workload.service.js.map