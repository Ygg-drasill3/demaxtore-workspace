export class ScaleForecastService {
    ...
    async getForecast(horizonDays) {
        ...
        const expectedContainerCount = Math.ceil(containerFactor * (horizonDays / 30) + activeFreight * 0.3);
    ...
    async auditForecast(horizonDays, revenue) {
...
//# sourceMappingURL=scale-forecast.service.js.map