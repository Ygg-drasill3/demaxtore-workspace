import { z } from "zod";
import { CreateCommodityBidDraftInput, ActionEnvelope, ScheduleAuctionPayload, CancelBidPayload, SubmitBidLotPayload, ReviseBidLotPayload, WithdrawBidLotPayload, ListCommodityBidQuery, } from "@dmx/contracts/commoditybid.zod";
...
async function loadAccessible(req) {
    ...
    if (!id || !looksLikeUuid(id))
        throw new AppError(404, "COMMODITYBID_NOT_FOUND");
    ...
    if (!ws || ws.type !== "COMMODITYBID")
        throw new AppError(404, "COMMODITYBID_NOT_FOUND");
    if (!(await canAccessCommodityBid(prisma, req.user, ws.id)))
...
export const commoditybidController = {
    ...
    async submitBidLot(req, res) {
        ...
        const act = action ? "revise_bid_lot" : "submit_bid_lot";
...
//# sourceMappingURL=commoditybid.controller.js.map