...
api.use("/workspaces/:workspaceType/:workspaceId/conversation", conversationHubRouter);
api.use("/workspace-communication/:workspaceType/:workspaceId", workspaceCommunicationRouter);
if (process.env.NODE_ENV === "test") {
    api.post("/internal/messaging/socket-emit-test", asyncHandler(async (req, res) => {
