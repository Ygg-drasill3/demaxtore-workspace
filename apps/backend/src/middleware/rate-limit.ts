 ...
 */
const FAILED_LOGIN_MAX_PER_IP = parseInt(
  process.env.LOGIN_RATE_LIMIT_MAX ?? (isProd ? "20" : "300"),
  10,
);
 ...
 */
const FAILED_LOGIN_MAX_PER_IDENTITY = parseInt(
  process.env.LOGIN_IDENTITY_RATE_LIMIT_MAX ?? (isProd ? "10" : "300"),
  10,
);
