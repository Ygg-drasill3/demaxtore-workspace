...
import { operationalTaskRouter } from "./modules/operational-task/operational-task.routes.js";
import { operationalIssueRouter } from "./modules/operational-issue/operational-issue.routes.js";
import { operationalAnalyticsRouter } from "./modules/operational-analytics/operational-analytics.routes.js";
import { operationalConfigurationRouter } from "./modules/operational-configuration/operational-configuration.routes.js";
...
import { partnerWorkspaceRouter } from "./modules/partner-workspace/partner-workspace.routes.js";
...
import { productMasterRouter } from "./modules/product-master/product-master.routes.js";
import { customsRouter } from "./modules/customs/customs.routes.js";
import { inlandDeliveryRouter } from "./modules/inland/inland-delivery.routes.js";
import { landedCostRouter } from "./modules/landed-cost/landed-cost.routes.js";
...
import { workspaceAcademyRouter } from "./modules/workspace-academy/workspace-academy.routes.js";
...
import { supplierOrganisationRouter } from "./modules/supplier-organisation/supplier-organisation.routes.js";
import { supplierInterestRouter } from "./modules/supplier-interest/supplier-interest.routes.js";
import { whatsappIntegrationsRouter, whatsappAdminRouter, whatsappBusinessLegacyRouter } from "./modules/whatsapp-business/whatsapp-business.routes.js";
import { whatsappUnresolvedAdminRouter } from "./modules/whatsapp-business/whatsapp-unresolved-admin.routes.js";
import { whatsappBusinessE2eRouter, shouldMountWhatsappE2eRoutes } from "./modules/whatsapp-business/whatsapp-business.e2e.routes.js";
...
api.use("/rfq/:id/attachments", resolveRfqParam, attachmentsRoutes);  // Phase G1
api.use("/rfq/:id/quotations",  resolveRfqParam, quotationsRoutes);   // Sprint 2.7
api.use("/rfq/:id/supplier-activity", resolveRfqParam, supplierActivityRoutes);
...
api.use("/tasks", operationalTaskRouter);
api.use("/issues", operationalIssueRouter);
api.use("/analytics", adminAnalyticsLimiter, operationalAnalyticsRouter);
api.use("/operations", operationalConfigurationRouter);
api.use("/telemetry",     telemetryBurstLimiter, telemetryRoutes);
api.use("/control-tower", adminAnalyticsLimiter, controlTowerRouter);
api.use("/partner", partnerWorkspaceRouter);
...
api.use("/workspace-academy", workspaceAcademyRouter);
...
api.use("/products", productMasterRouter);
api.use("/customs", customsRouter);
api.use("/inland", inlandDeliveryRouter);
api.use("/landed-cost", landedCostRouter);
...
api.use("/supplier-organisations", supplierOrganisationRouter);
api.use("/supplier-interests", supplierInterestRouter);
api.use("/phone-verification", phoneVerificationRoutes);
api.use("/integrations/whatsapp", whatsappIntegrationsRouter);
api.use("/admin", whatsappAdminRouter);
api.use("/admin", whatsappUnresolvedAdminRouter);
if (shouldMountWhatsappE2eRoutes()) {
  api.use("/internal/e2e", whatsappBusinessE2eRouter);
}
api.use("/settings/integrations/whatsapp-business", whatsappBusinessLegacyRouter);
