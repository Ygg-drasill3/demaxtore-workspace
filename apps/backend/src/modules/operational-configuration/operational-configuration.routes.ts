...
operationalConfigurationRouter.get(
  "/configuration",
  requireAuth,
...
operationalConfigurationRouter.patch(
  "/configuration",
  requireAuth,
  asyncHandler(async (req: Request, res: Response) => {
...
operationalConfigurationRouter.post(
  "/templates/tasks",
  requireAuth,
  asyncHandler(async (req: Request, res: Response) => {
