...
export interface SpawnOrderInput {
  ...
  parentType: "RFQ" | "COMMODITYBID" | "MIXED_CONTAINER" | "BULK_CONTAINER";
  ...
  actorUserId: string;
  auditEvent: "order.created_from_rfq" | "order.created_from_commoditybid" | "order.created_from_mixed_container" | "order.created_from_bulk_container";
