...
export const supplierOrganisationController = {
  getLogo: async (req: Request, res: Response) => {
    ...
    if (!org?.logoStorageKey || !org.logoMimeType) throw new AppError(404, "LOGO_NOT_FOUND");
  ...
  getCatalog: async (req: Request, res: Response) => {
    ...
    if (!org?.catalogStorageKey || !org.catalogMimeType) throw new AppError(404, "CATALOG_NOT_FOUND");
