...
operationalTaskRouter.get(
  "/:id/comments",
  requireAuth,
  asyncHandler(operationalTaskController.listComments),
);
operationalTaskRouter.post(
  "/:id/comments",
  requireAuth,
  asyncHandler(operationalTaskController.addComment),
);
operationalTaskRouter.delete(
  "/:id/comments/:commentId",
  requireAuth,
  asyncHandler(operationalTaskController.deleteComment),
);
