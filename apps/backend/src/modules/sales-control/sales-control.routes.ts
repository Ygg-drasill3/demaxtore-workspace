...
salesControlRouter.get(
  ...
  requireAuth,
  requireRole("ADMIN", "SALES_CONTROL"),
  asyncHandler(salesControlController.listInterestCategories),
);
...
salesControlRouter.get(
  ...
  requireAuth,
  requireRole("ADMIN", "SALES_CONTROL"),
  asyncHandler(salesControlController.getCustomer),
);

salesControlRouter.patch(
  "/customers/:id",
  requireAuth,
  requireRole("ADMIN", "SALES_CONTROL"),
  asyncHandler(salesControlController.updateCustomer),
);
...
salesControlRouter.post(
  ...
  uploadLimiter,
  uploadSingle,
  asyncHandler(salesControlController.uploadLogo),
);
...
salesControlRouter.post(
  ...
  uploadLimiter,
  uploadSingle,
  asyncHandler(salesControlController.uploadCatalog),
);

salesControlRouter.put(
  "/customers/:id/catalog-link",
  requireAuth,
  requireRole("ADMIN", "SALES_CONTROL"),
  asyncHandler(salesControlController.setCatalogLink),
);
