...
import {
  LinkTradeShipmentSchema,
  UpsertShipmentLineAllocationSchema,
} from "@dmx/contracts/trade-lineage";
...
export const tradeLineageController = {
  ...
  linkShipment: async (req: Request, res: Response) => {
  ...
  backfillAllocations: async (req: Request, res: Response) => {
