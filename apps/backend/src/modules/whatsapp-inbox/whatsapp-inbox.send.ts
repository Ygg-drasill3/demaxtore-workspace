...
function buildPayload(input: SendMessageInput): Record<string, unknown> {
...
export async function sendWhatsAppMessage(input: SendMessageInput): Promise<MetaSendResult> {
