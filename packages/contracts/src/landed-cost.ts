...
export const LANDED_COST_NATURES = ["ESTIMATED", "ACTUAL"] as const;
...
export const LANDED_COST_SCOPES = ["SHIPMENT", "PO"] as const;
...
export const LANDED_COST_REQUIRED_DEFAULT = ["GOODS", "FREIGHT"] as const;
...
export function landedCostDisplayLabel(status: LandedCostStatus): string {
  switch (status) {
    case "ACTUAL":
