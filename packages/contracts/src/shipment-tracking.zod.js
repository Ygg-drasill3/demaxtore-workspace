...
export const LinkTrackingPayload = z
    ...
    .refine((v) => !!(v.containerNumber || v.bookingNumber || v.vesselReference), { message: "Provide container number, booking number, or vessel reference" });
//# sourceMappingURL=shipment-tracking.zod.js.map