 ...
 */
export const SHIPMENT_EXCEPTION_TO_ORDER_MIRROR = {
    VESSEL_DELAY: "none",
    CUSTOMS_HOLD: "none",
...
export const ORDER_DISPUTE_COMMERCIAL_CATEGORIES = [
    "QUALITY",
    "PAYMENT",
    "DAMAGE",
];
export function shouldSuggestOrderDispute(category) {
    return SHIPMENT_EXCEPTION_TO_ORDER_MIRROR[category] === "suggest_dispute";
}
//# sourceMappingURL=exception-taxonomy.js.map