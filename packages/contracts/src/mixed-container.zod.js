...
export const MC_ALLOCATION_STATUSES = ["ASSIGNED", "PROFORMA_REQUESTED", "PROFORMA_UPLOADED", "PAYMENT_PENDING", "PAYMENT_CONFIRMED"];
export const MC_PROFORMA_STATUSES = ["REQUESTED", "UPLOADED", "BUYER_REVIEWED"];
export const MC_PAYMENT_STATUSES = ["PENDING", "PAYMENT_SENT", "PAYMENT_CONFIRMED"];
...
//# sourceMappingURL=mixed-container.zod.js.map