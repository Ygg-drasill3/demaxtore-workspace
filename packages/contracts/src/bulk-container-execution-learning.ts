export const BULK_POST_EXECUTION_READY_LEARNING = {
  summary:
    "When your BulkContainer reaches Execution Ready, DeMaxtore Operations spawns one master BulkContainer order " +
...
export const BULK_FREIGHTIQ_CONNECTION_LEARNING = {
  summary:
    "BulkContainer supplier orders use the same FreightIQ eligibility rules as RFQ and SmartContainer orders. No separate freight workflow exists.",
  topics: [
...
export const BULK_EXECUTION_UNDERSTANDING_LEARNING = {
  summary:
    "BulkContainer execution is coordination-only until spawn. After spawn, Trade OS runs fulfillment while you monitor one unified dashboard.",
  topics: [
