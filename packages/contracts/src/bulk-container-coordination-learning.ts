export const BULK_PAYMENTS_LEARNING = {
  summary:
    "BulkContainer payments are direct buyer-to-supplier. DeMaxtore coordinates allocation, proforma collection, and payment confirmation — no payment gateway on the platform.",
  topics: [
...
export const BULK_SUPPLIER_HIDDEN_LEARNING = {
  summary:
    "Supplier identities are never shown to buyers in BulkContainer. Operations uses internal codes; buyers see allocation references only.",
  topics: [
...
export const BULK_PRE_EXECUTION_LEARNING = {
  summary:
    "Before execution, every approved BulkContainer must complete allocation, proforma, and payment gates. Execution Ready means all coordination is complete.",
  topics: [
