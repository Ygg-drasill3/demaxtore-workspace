...
export function buildCatalogProductDescription(intake, extraBlocks = []) {
    const catalogLines = [
...
export function catalogIntakeFromIngestBody(body) {
...
//# sourceMappingURL=catalog-rfq-intake.js.map