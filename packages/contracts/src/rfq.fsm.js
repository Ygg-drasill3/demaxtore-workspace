...
// -----------------------------------------------------------------------------
export const RFQ_TERMINAL_STATES = ["CANCELLED", "EXPIRED", "CLOSED_NO_AWARD", "PO_ISSUED", "CLOSED"];
...
export function findRfqTransition(from, action) {
    return RFQ_TRANSITIONS.find((t) => (t.from === from || t.from === "*") && t.action === action);
}
//# sourceMappingURL=rfq.fsm.js.map