export const BULK_PRICING_LEARNING = {
  summary:
    "BulkContainer pricing is operations-led: you submit a specification-based request, and DeMaxtore procurement sources suppliers offline and prepares a buyer-ready offer.",
  topics: [
...
export const BULK_OFFER_EXPIRY_LEARNING = {
  summary:
    "Bulk offers expire after 72 hours by default. Pricing reflects current supplier quotes and market conditions at offer time.",
  topics: [
...
export const BULK_SPEC_PRICING_LEARNING = {
  summary:
    "Technical specifications directly affect bulk pricing. Different protein, ash, moisture, or origin requirements map to different supplier quotes.",
  topics: [
