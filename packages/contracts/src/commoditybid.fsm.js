...
// =============================================================================
export const COMMODITYBID_TERMINAL_STATES = [
    "ORDERS_SPAWNED", "REJECTED", "CANCELLED", "EXPIRED", "CLOSED_NO_AWARD",
];
export function isCommodityBidTerminal(state) {
    return COMMODITYBID_TERMINAL_STATES.includes(state);
}
export const COMMODITYBID_TRANSITIONS = [
