...
export declare function toWorkspaceScriptRole(role: string): WorkspaceScriptRole | undefined;
...
export declare function formatScript<T extends Record<string, string | number | null | undefined>>(text: string, vars: T): string;
