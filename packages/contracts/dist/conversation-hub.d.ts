...
export declare const TimelineItemType: readonly ["MESSAGE", "DOCUMENT", "QUESTION", "ANSWER", "DECISION", "APPROVAL", "ACTION_REQUIRED", "SYSTEM_EVENT", "STATUS_UPDATE", "INTERNAL_NOTE"];
export type TimelineItemType = (typeof TimelineItemType)[number];
export declare const SystemEventType: readonly ["WORKSPACE_CREATED", "RFQ_PUBLISHED", "QUOTATION_SUBMITTED", "SUPPLIER_SELECTED", "COMMODITYBID_CLOSED", "PURCHASE_ORDER_ISSUED", "INSPECTION_SCHEDULED", "SHIPMENT_BOOKED", "ETA_UPDATED", "SHIPMENT_DELIVERED"];
export type SystemEventType = (typeof SystemEventType)[number];
export declare const ConversationParticipantRole: readonly ["BUYER", "SUPPLIER", "DEMAXTORE_REPRESENTATIVE"];
export type ConversationParticipantRole = (typeof ConversationParticipantRole)[number];
export declare const DeliveryState: readonly ["SENT", "DELIVERED", "READ"];
...
export type PendingActionKind = "WAITING_SUPPLIER_REPLY" | "BUYER_APPROVAL_REQUIRED" | "INSPECTION_REPORT_WAITING" | "ETA_UPDATED" | "DOCUMENT_MISSING" | "ACTION_REQUIRED" | "UNANSWERED_QUESTION";
...
export type AttachmentCategory = "QUOTATION" | "PURCHASE_ORDER" | "INSPECTION" | "CERTIFICATE" | "INVOICE" | "PACKING_LIST" | "BILL_OF_LADING" | "PHOTO" | "VIDEO" | "OTHER";
