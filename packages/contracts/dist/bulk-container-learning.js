export const BULK_CONTAINER_LEARNING = {
    summary: "BulkContainer is DeMaxtore's multi-supplier bulk procurement workspace for horeca, industrial, and wholesale food buyers. " +
...
export const BULK_CONTAINER_PROCUREMENT_LEARNING = {
    summary: "BulkContainer follows operations-led managed sourcing: you build and submit, operations procures, you approve the offer, then execution begins.",
    topics: [
