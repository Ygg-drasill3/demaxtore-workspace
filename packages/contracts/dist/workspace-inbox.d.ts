...
export declare const InboxAttentionBadge: readonly ["WAITING_REPLY", "APPROVAL_REQUIRED", "DELAYED", "NEW_MESSAGE", "INSPECTION", "ETA_UPDATED", "COMPLETED"];
export type InboxAttentionBadge = (typeof InboxAttentionBadge)[number];
export declare const InboxFilter: readonly ["all", "rfq", "commoditybid", "purchase_orders", "shipments", "completed", "waiting_for_me", "unread", "delayed", "archived"];
