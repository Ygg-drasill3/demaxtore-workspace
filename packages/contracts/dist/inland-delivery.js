...
export const INLAND_POD_STATUSES = ["NOT_REQUIRED", "PENDING", "AVAILABLE"];
export const INLAND_TRANSITIONS = {
...
export const INLAND_CUSTOMS_GATED_STATUSES = [
    "READY_FOR_PICKUP",
    "PICKED_UP",
    "GATE_OUT",
    "IN_TRANSIT",
...
export function canTransitionInland(from, to) {
