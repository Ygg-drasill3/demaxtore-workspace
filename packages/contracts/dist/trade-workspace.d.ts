export type TradeType = "RFQ" | "COMMODITYBID" | "MIXED_CONTAINER" | "BULK_CONTAINER";
export type TradeExecutionMilestone = "Created" | "Quoted" | "PO Created" | "Order Confirmed" | "Production" | "Shipment" | "Delivered";
export type TradeDocumentCategory = "Proforma" | "Invoice" | "Packing List" | "BL" | "COO" | "Health Certificate" | "Inspection Reports" | "Contracts" | "Other";
