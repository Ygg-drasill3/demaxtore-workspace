import { z } from "zod";
import { CommunicationChannel, OfferSource } from "./freight-communications.js";
...
export const IntakeFreightOfferPayload = z
    ...
    .refine((d) => (d.internalCostUsd ?? d.oceanFreight) !== undefined, { message: "internalCostUsd or oceanFreight required", path: ["internalCostUsd"] });
